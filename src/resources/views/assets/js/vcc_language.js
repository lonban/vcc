        ...
        'vc2_languageSwitching':function()
        {
            var A = {
                ...
                ajax_:function(obj,locale,currency)
                {
                    ...
                    function url_f(url){
                        var reg = new RegExp("(^|&|/?)(locale|currency|vcc_locale_break)=([^&]*)");
                        url = url.replace(reg,'');
                        if(reg.test(url)){
                            url = url_f(url);
                        }
                ...
                if(data.tel && data.tel.length>0){
                    ...
                    switch(address.val()){
                        case '1':
                            div.show().val('+1');
                            div_bottom.html('1');
                            obj.attr('vcc_length','10,11');//1美国10
                            break;
                        case '4':
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','10');//4法国10
                            break;
                        case '5':
                            div.show().val('+49');
                            div_bottom.html('49');
                            obj.attr('vcc_length','9,11');//5德国11
                            break;
                        case '8':
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','10');//8意大利10
                            break;
                        case '9':
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','9');//9西班牙9
                            break;
                        case '17':
                            div.show().val('+44');
                            div_bottom.html('44').parent().show();
                            obj.attr('vcc_length','10,11');//17英国10
                            break;
                        case '114':
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','10');//114香港10
                            break;
                        case '117':
                            div.show().val('+91');
                            div_bottom.html('91').parent().show();
                            obj.attr('vcc_length','9,11');//117印度尼西亚12
                            break;
                        case '122':
                            div.show().val('+81');
                            div_bottom.html('81').parent().show();
                            obj.attr('vcc_length','10,11');//122日本11
                            break;
                        case '145':
                            div.show().val('+60');
                            div_bottom.html('60').parent().show();
                            obj.attr('vcc_length','9,11');//145马来西亚10,11
                            break;
                        case '182':
                            div.show().val('+63');
                            div_bottom.html('63').parent().show();
                            obj.attr('vcc_length','10,11');//182菲律宾10
                            break;
                        case '205':
                            div.show().val('+65');
                            div_bottom.html('65').parent().show();
                            obj.attr('vcc_length','8');//205新加坡8
                            break;
                        case '219':
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','10');//219台湾10
                            break;
                        case '222':
                            div.show().val('+66');
                            div_bottom.html('66').parent().show();
                            obj.attr('vcc_length','9,10');//222泰国10
                            break;
                        case '241':
                            div.show().val('+84');
                            div_bottom.html('84').parent().show();
                            obj.attr('vcc_length','9,11');//241 越南10,11
                            break;
                        default:
                            div.hide();
                            div_bottom.html('');
                            obj.attr('vcc_length','16');
                    }
                }
